...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      <div className="relative flex items-center gap-3 bg-[#0f172a] hover:bg-[#020617] text-white px-5 py-3 rounded-full shadow-2xl transition-all duration-300 border border-[#f59e0b]/40 backdrop-blur-md">
