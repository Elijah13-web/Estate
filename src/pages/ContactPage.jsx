...
//   // ✅ WHATSAPP BOOST (Nigeria optimized)
//   const handleWhatsApp = () => {
//     const phoneNumber = "2348022947444"; 

//     const text = `Hello Markson Ajiboye Consulting Services,
...
//   // 🎯 floating input component (FIXED)
//   const FloatingInput = ({
//     label,
//     value,
//     onChange,
...
//         placeholder=" "
//         onChange={onChange}
//         className={`peer w-full h-14 rounded-xl border bg-white/70 backdrop-blur px-4 pt-6 pb-2 text-sm outline-none transition-all
//         focus:ring-2 focus:ring-[#d09d1e]/40
...
//       {error && (
//         <p className="text-red-500 text-sm mt-1 animate-in fade-in">
//           {error}
//         </p>
//       )}
//     </div>
...
//               <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#d09d1e]">
//                 Get in Touch
//               </p>
...
//                     <MapPin className="w-5 h-5 text-[#d09d1e]" strokeWidth={2.4} />
//                   </div>
//                   <p className="text-muted-foreground">
//                     126, Obafemi Awolowo Way, Ikeja, Lagos, Nigeria
//                   </p>
//                 </div>

//                 <div className="flex items-start gap-4">
//                   <div className="p-3 rounded-full bg-[#d09d1e]/10 shadow-sm">
//                     <Phone className="w-5 h-5 text-[#d09d1e]" strokeWidth={2.4} />
//                   </div>
...
//                 <div className="flex items-start gap-4">
//                   <div className="p-3 rounded-full bg-[#d09d1e]/10 shadow-sm">
//                     <Mail className="w-5 h-5 text-[#d09d1e]" strokeWidth={2.4} />
//                   </div>
//                   <a
...
//                   className={`w-full h-16  rounded-xl border  px-4 bg-white/70 backdrop-blur
//                   focus:ring-2 focus:ring-[#d09d1e]/40
...
//                   className={`w-full rounded-xl border p-4 bg-white/70 backdrop-blur
//                   focus:ring-2 focus:ring-[#d09d1e]/40
...
//                 className="w-full bg-[#d09d1e] hover:bg-[#ffb702] h-14 text-base font-semibold transition-all duration-300 hover:shadow-lg disabled:opacity-60 cursor-pointer"
//               >
//                 {isSubmitting ? (
...
//                 className="w-full h-14 bg-green-600 hover:bg-green-700 text-white font-semibold cursor-pointer"
//               >
//                 Chat on WhatsApp
//               </Button>
...
//             <CheckCircle2 className="w-14 h-14 text-[#d09d1e] mx-auto mb-4" />
...
/* ================= FLOATING INPUT (OUTSIDE COMPONENT — IMPORTANT FIX) ================= */
const FloatingInput = ({
  label,
  value,
  onChange,
...
const ContactPage = () => {
  ...
  /* ================= UI ================= */
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-b from-white via-[#faf7ef] to-white">
      <section className="py-24 font-serif">
        <div className="container mx-auto p-6 lg:px-0">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            {/* LEFT */}
